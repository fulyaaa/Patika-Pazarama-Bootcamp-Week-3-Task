...
class SecondFragment3 : Fragment(), ProductListener {
    ...
    private fun setupAdapter(){
        rvProductList.adapter = ProductAdapter(mockProductData, this@SecondFragment3)
    ...
    override fun onClicked(product: ProductModel) {
        navController.navigate(R.id.action_secondFragment3_to_thirdFragment, Bundle().apply {
