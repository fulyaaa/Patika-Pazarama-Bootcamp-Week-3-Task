...
class SecondFragment2 : Fragment(), ProductListener {
    ...
    private fun setupAdapter(){
        rvProductList.adapter = ProductAdapter(mockProductData, this@SecondFragment2)
    ...
    override fun onClicked(product: ProductModel) {
        navController.navigate(R.id.action_secondFragment2_to_thirdFragment, Bundle().apply {
